...
import com.suzl.entity.VerificationOrder;
import com.suzl.seller.enums.ChanEnum;
import com.suzl.seller.repositoriesbackup.VerifyRepository;
...
public class VerifyService {
    ...
    @Value("${verification.rootdir:D:\\suzl\\financial}")
